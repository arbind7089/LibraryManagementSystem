...
<?php $get_id = $_GET['id']; ?>
    ...
    $con = mysqli_connect('localhost','root','', 'lms')or die(mysqli_error());
		...
		?>
			...
			<p><a class="btn btn-info" href="student.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a></p>
    ...
    <div class="control-group">
      ...
      <div class="controls">
      <input type="text" id="inputEmail" name="username" value="<?php echo $row['username']; ?>" placeholder="Username" required>
      <input type="hidden" id="inputEmail" name="id" value="<?php echo $get_id;  ?>" placeholder="Username" required>
      </div>
    </div>
    ...
    <div class="control-group">
			...
			<div class="controls">
			<input type="text" id="inputEmail" name="password" value="<?php echo $row['password']; ?>" placeholder="Password" required>
			<input type="hidden" id="inputEmail" name="id" value="<?php echo $get_id;  ?>" placeholder="Password" required>
			</div>
		</div>
